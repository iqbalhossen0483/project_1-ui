...
const Banner = () => {
    return (
        <div className="sm:grid grid-cols-2 bg-white sm:pt-10">
            <div className="pt-10 sm:pt-0 flex justify-center items-center">
                <div className="lg:leading-10">
                    ...
                    <Link to="/appointment">
                        <button
                            className="border rounded-md mt-2 sm:mt-6 px-3 py-1 bg-blue-600 text-white font-semibold text-xl">
                            take a appointment
                        </button>
                    </Link>
                </div>
